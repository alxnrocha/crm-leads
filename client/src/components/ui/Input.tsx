      ...
      <div className="w-full space-y-1.5 text-left">
        ...
        <div className="relative flex items-center">
          ...
          <input
            ...
            className={twMerge(
              clsx(
                'w-full px-3.5 py-2 text-sm rounded-xl border bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100 placeholder:text-slate-400 dark:placeholder:text-slate-500 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-1',
                error
